...
var widget = widgets.Widget({
   ...
   panel: panel,
   onMouseover: initializeUI 
});

var initializeUI = function() {
   var title = tabs.activeTab.title;
   var feed = simpleStorage.storage.feed;
   var customServer = simpleStorage.storage.customServer;
   this.panel.postMessage({'description': title, 'feed': feed, 'customServer': customServer});
};
